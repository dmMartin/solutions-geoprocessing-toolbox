...
class ERGByChemical(object):
    ...
    def getParameterInfo(self):
        ...
        param5.value = arcpy.CreateScratchName("ERGAreasByChemical", "", "FeatureClass", arcpy.env.scratchGDB)
        ...
        param6.value = arcpy.CreateScratchName("ERGLinesByChemical", "", "FeatureClass", arcpy.env.scratchGDB)
...
class ERGByPlacard(object):
    ...
    def getParameterInfo(self):
        ...
        param5.value = arcpy.CreateScratchName("ERGAreasByPlacard", "", "FeatureClass", arcpy.env.scratchGDB)
        ...
        param6.value = arcpy.CreateScratchName("ERGLinesByPlacard", "", "FeatureClass", arcpy.env.scratchGDB)
